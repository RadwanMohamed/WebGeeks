    ...
    <div class="portlet-body flip-scroll">
        <table class="table table-bordered table-striped table-condensed flip-content">
            ...
            @foreach($services as $service)
                ...
                <td class="numeric"> {{$service->Desc}} </td>
                <td class="numeric"> {{$service->user->name}} </td>
                <td class="numeric"> {{$service->created_at}} </td>
                <td class="numeric"> {{$service->updated_at}} </td>
                <td class="numeric">
                    <button type="button" class="btn green editservice"  data-toggle="modal" data-target="#basic" href="/admin-panel/services/{{$service->id}}/edit" >Edit</button>
                    <button  type="button" class="btn red delete" href="/admin-panel/services/{{$service->id}}/delete" >DEL</button>
                </td>
                </tr>
            @endforeach
            <tr>

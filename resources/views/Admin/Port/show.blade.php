    ...
    <div class="portlet-body flip-scroll">
        <table class="table table-bordered table-striped table-condensed flip-content">
            ...
            @foreach($ports as $port)
                ...
                <td class="numeric"> {{$port->category}} </td>
                <td class="numeric"> {{$port->content}} </td>
                <td class="numeric"> {{$port->desc}} </td>
                <td class="numeric"> {{$port->user->name}} </td>
                <td class="numeric"> {{$port->created_at}} </td>
                <td class="numeric"> {{$port->updated_at}} </td>
                <td class="numeric">
                    <button type="button" class="btn green editproject"  data-toggle="modal" data-target="#basic" href="/admin-panel/port/{{$port->id}}/edit" >Edit</button>
                    <button  type="button" class="btn red delete" href="/admin-panel/port/{{$port->id}}/delete" >DEL</button>
                </td>
                </tr>
            @endforeach
            <tr>

...
<div class="form-body">
    <form action="{{url('admin-panel/categories/add')}}" method="post" enctype="multipart/form-data" class="form">
       ...
       formResults = form.find('#form-results');
          ...
          $.ajax({
            ...
            success: function (data) {
                ...
                formResults.removeClass().addClass('alert alert-success').html('the category added sucessfully');
            },
            cache: false,
            processData: false,
            contentType: false,

    ...
    <div class="portlet-body flip-scroll">
        <table class="table table-bordered table-striped table-condensed flip-content">
            ...
            @foreach($cats as $cat)
                ...
                <td class="numeric"> {{$cat->user->name}} </td>
                <td class="numeric"> {{$cat->created_at}} </td>
                <td class="numeric"> {{$cat->updated_at}} </td>
                <td class="numeric">
                    <button type="button" class="btn green editcat"  data-toggle="modal" data-target="#basic" href="/admin-panel/categories/{{$cat->id}}/edit" >Edit</button>
                    <button  type="button" class="btn red delete" href="/admin-panel/categories/{{$cat->id}}/delete" >DEL</button>
                </td>
                </tr>
            @endforeach
            <tr>
